...
//  how much you like pizza. The output should consist of three or more lines about the kinds 
//  of pizza you like and then an additional sentence, such as I really love pizza!

//  creating an Array...
 let pizza =["Chicken Tikka" , "Malai Tikka", "Cheese Tikka "];
...
//  Pint a message outside of thr loop..
console.log("Pizza is everything");
