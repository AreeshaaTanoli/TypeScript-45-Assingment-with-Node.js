...
// test 3 
console.log("Test 3 : ten is not equal to 5?");
console.log(ten != 5);
console.log("--------------------");

//  test 4

console.log("Test 4 : six is less than 7?");
console.log( six < 7);
console.log("--------------------");

//  test 5
console.log("Test 5 : eight is greater than 4?");
console.log( eight > 4);
console.log("--------------------");
...
// test 7
console.log("Test 7 : eight is equal to   10?");
console.log(eight == 10);
console.log("--------------------");

//  test 8
console.log("Test 8 : 9 is less than 8?");
console.log(nine < 8);
console.log("--------------------");

// test 9
console.log("Test 9 : nine  is greater than ten?");
console.log(nine > 10);
console.log("--------------------");

//  test 10 
console.log("Test 10 : seven is not equal to 7?");
console.log(seven < 7);
console.log("--------------------");
